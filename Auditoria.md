...
- **Estado parcial:** staging aprovado; `QA-04` permanece `em teste` apenas pela calibração humana do juiz e pelo soak de 14 dias. Observador e promoção de produção seguem na mesma execução e serão registrados nesta entrada.
