/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: af92c7fc3b865f390c74a99d8762e9af)
// Runtime types generated with workerd@1.20260730.1 2026-07-05 nodejs_compat
interface __BaseEnv_Env {
	...
	META_APP_ID: "344941004274813";
	META_EXPECTED_PHONE_ID: "177462062115446";
	META_EXPECTED_WABA_ID: "159711717233997";
	META_EXPECTED_CALLBACK_URL: "https://smartzap-cf.thales2581.workers.dev/webhook";
	...
	CLOUDFLARE_ACCOUNT_ID: "4a1961760bc2292fab3733dc2b3c811c";
	CLOUDFLARE_WORKER_NAME: "smartzap-cf";
	CLOUDFLARE_D1_DATABASE_ID: "38f79030-3d63-4331-ad32-6c329d948267";
	...
	REALTIME: DurableObjectNamespace<import("./src/index").RealtimeHub>;
	THROTTLE: DurableObjectNamespace<import("./src/index").PhoneThrottle>;
	CAMPAIGN_WF: Workflow<Parameters<import("./src/index").CampaignSendWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RealtimeHub" | "PhoneThrottle";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "META_GRAPH_VERSION" | "META_APP_ID" | "META_EXPECTED_PHONE_ID" | "META_EXPECTED_WABA_ID" | "META_EXPECTED_CALLBACK_URL" | "TURNSTILE_ENABLED" | "AI_ENABLED" | "AI_MODEL" | "AI_GATEWAY_ID" | "AI_PROVIDER_TIMEOUT_MS" | "AI_MAX_DRAFTS_PER_CONVERSATION_HOUR" | "AI_MAX_DRAFTS_PER_DAY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_WORKER_NAME" | "CLOUDFLARE_D1_DATABASE_ID" | "FLOW_DATA_API_VERSION" | "INBOX_SEND_ENABLED" | "INBOX_AUTOMATION_ENABLED" | "AUTOMATION_QUEUE_NAME" | "CAPI_QUEUE_NAME" | "MASTER_PASSWORD" | "SMARTZAP_API_KEY" | "QA_READONLY_API_KEY" | "META_APP_SECRET" | "META_VERIFY_TOKEN" | "CLOUDFLARE_ANALYTICS_TOKEN" | "WHATSAPP_TOKEN" | "FLOW_PRIVATE_KEY" | "FLOW_PUBLIC_KEY">> {}
}
